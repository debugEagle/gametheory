...
public class TestAbstractor<PlayerId> implements NLBetTreeAbstractor<PlayerId> {
	...
	public List<Move<PlayerId>> movesForHand(NLHand<PlayerId> hand) {
		...
		case BLINDS:
			...
			final PlayerId blindsPlayer = blinds.keySet().iterator().next();
