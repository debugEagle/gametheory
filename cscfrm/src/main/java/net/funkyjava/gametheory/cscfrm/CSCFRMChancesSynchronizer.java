...
public class CSCFRMChancesSynchronizer {
	...
	@Setter
	private int availableChancesFloor = 100;
	@Setter
	private int numberToProduceEachTime = 200;
	...
	public CSCFRMChancesSynchronizer(final CSCFRMChancesProducer producer, final int[][] chancesSizes) {
