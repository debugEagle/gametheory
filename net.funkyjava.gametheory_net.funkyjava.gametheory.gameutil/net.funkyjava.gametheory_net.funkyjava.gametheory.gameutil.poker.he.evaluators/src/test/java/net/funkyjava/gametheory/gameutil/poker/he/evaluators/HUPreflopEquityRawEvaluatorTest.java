...
public class HUPreflopEquityRawEvaluatorTest {
	...
	public void testTimeOnePreflopHand() {
		...
		HUPreflopEquityRawEvaluator eval = new HUPreflopEquityRawEvaluator(specs, new TwoPlusTwoEvaluator());
		...
		int[][] hand = { { cString.getCard(c1), cString.getCard(c2) }, { cString.getCard(c3), cString.getCard(c4) } };
