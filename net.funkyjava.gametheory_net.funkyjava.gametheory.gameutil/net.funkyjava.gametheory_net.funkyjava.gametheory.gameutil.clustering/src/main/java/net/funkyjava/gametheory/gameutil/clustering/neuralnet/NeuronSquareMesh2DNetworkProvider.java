...
public class NeuronSquareMesh2DNetworkProvider implements NetworkProvider {
	...
	public NeuronSquareMesh2DNetworkProvider(int numRows, boolean wrapRowDim, int numCols, boolean wrapColDim,
	...
	public Network createNetwork() {
		return new NeuronSquareMesh2D(numRows, wrapRowDim, numCols, wrapColDim, neighbourhoodType, featureInit)
				.getNetwork();
	}
