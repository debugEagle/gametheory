...
public class NeighbourhoodConvergenceMonitorProvider implements NetworkConvergenceMonitorProvider {
	...
	public NeighbourhoodConvergenceMonitorProvider(final NeighbourhoodSizeFunction neighbourhoodSize) {
		this.neighbourhoodSize = neighbourhoodSize;
	}

	@Override
	public <T extends Clusterable> NeighbourhoodConvergenceMonitor createMonitor(Network network, List<T> points) {
